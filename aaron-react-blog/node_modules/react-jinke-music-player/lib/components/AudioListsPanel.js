...
var AudioListsPanel = function AudioListsPanel(_ref) {
  ...
  return _react.default.createElement("div", {
    ...
    className: "close-btn",
    title: "Close"
  }, _defineProperty({}, isMobile ? "onTouchStart" : "onClick", onCancel)), closeIcon), remove ? _react.default.createElement(_react.Fragment, null, _react.default.createElement("span", {
    className: "line",
    key: "line"
  ...
  }, _defineProperty({}, isMobile ? "onTouchStart" : "onClick", onDelete())), deleteIcon)) : undefined)), _react.default.createElement("div", {
    ...
    return _react.default.createElement("li", _extends({
      ...
      key: "player-time"
    }, singer), remove ? _react.default.createElement("span", _extends({
      className: "group player-delete",
      key: "player-delete",
      title: "Click to delete ".concat(name)
    }, _defineProperty({}, isMobile ? "onTouchStart" : "onClick", onDelete(i))), closeIcon) : undefined);
